...
fail=0
for t in test_loop test_tools test_endtoend test_behaviour test_checks_editing test_llm_cli test_wordcount test_foundation test_browser test_brand test_reddit test_research test_write test_assets_wiring test_assets_formats test_assets_trends test_assets_competitors test_assets_merge test_assets_import test_store_live test_picture test_credit_guard test_prompts_parity test_stations test_find_prompt test_workspace_core test_workspace_sync test_workspace_pack test_chat_delete test_faces test_face_route test_workspace_heal test_companies test_dfs_console test_dfs_retry test_workspace_ideas test_source_check test_slots_pause test_research_settings test_library_edit test_workspace_library_backfill test_workspace_library_team test_stop_resume test_library_tabs test_library_tabs_shared test_key_preflight test_gap_and_world test_research_demand test_keyword_same_article test_card_filter_stakes test_shape_pass test_aparna_2026_09_23 test_write_keywords test_write_coverage; do
