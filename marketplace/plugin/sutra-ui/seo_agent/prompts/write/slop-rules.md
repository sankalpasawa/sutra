# The write phase's AI-slop ruleset

The full avoid-ai-writing v3.10.0 rules body, carried over VERBATIM (nothing summarised), minus the
chat-only patterns listed at the bottom, plus this pipeline's own hard rules. The slop step loads
this whole file into its prompt. To tune a rule, edit it here — one place.
...
### Vague attributions
- **The rule, not a word list:** if a sentence credits a claim to somebody, that somebody must be named. The publisher, the survey, the company that ran it, the author. Any word standing in for the name is the fault, however it is phrased.
- The familiar ones: "Experts believe," "Studies show," "Research suggests," "Industry leaders agree."
- The ones that slip past, because they sound precise while naming nobody: "one source," "one 2025 source," "a separate figure," "a separate survey," "a separate study," "one study," "some research," "a recent report," "a 2025 report," "data suggests," "reports indicate," "it has been found."
- Adding a year or a number does not fix it. "One 2025 source puts it at 41%" names nobody; it just sounds like it does.
- Fix: name the source, or drop the attribution and state the claim directly. If neither is possible because nobody knows where the figure came from, cut the claim.
- This matters most on any article that questions other people's evidence. Attacking undated, unsourced statistics while using an unnamed source is the same fault the article is describing, and a reader will notice.
...
## Deliberately dropped from the original (chat-only or locked upstream in this pipeline)

Acknowledgment loops · Confidence calibration phrases · Cutoff disclaimers · Excessive structure · Hashtag stuffing · Infomercial engagement hooks · Paragraph-reshuffle immunity (structure test) · Self-labeling significance · Social endorsement closers · Sycophantic tone · Title case headings · Vocabulary diversity (stylometric)
