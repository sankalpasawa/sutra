...
def task_context(mission):
    ...
    return (
        ...
        "\nON A TASK THAT HAS ALREADY FINISHED THIS FENCE DECIDES WHETHER "
        "THE TASK COMES BACK. `true` reopens it and puts the worker back to "
        "work; `false` leaves it finished and you simply answer. So a "
        "question about work that is already done -- \"print those ten lines "
        "here\", \"show me the file\", \"what did you put in it\", "
        "\"summarise what you made\" -- is `false`: the answer is in the "
        "result you already have, and you give it. \"Change it to 15 lines\" "
        "or \"update it with today's information\" is new work and is "
        "`true`.\n"
