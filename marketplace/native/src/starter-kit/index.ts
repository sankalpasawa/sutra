...
import { createWorkflow, type Workflow, type WorkflowSpec } from '../primitives/workflow.js'
...
export const DOMAIN_PERSONAL: Domain = createDomain({
  id: 'D1',
  name: 'Personal OS',
  parent_id: null,
  principles: [
...
export const DOMAIN_PRODUCT: Domain = createDomain({
  id: 'D2',
  name: 'Product Build',
  parent_id: null,
  principles: [
...
export const DOMAIN_RELATIONSHIPS: Domain = createDomain({
  id: 'D3',
  name: 'Relationships',
  parent_id: null,
  principles: [
...
export const DOMAIN_FINANCE: Domain = createDomain({
  id: 'D4',
  name: 'Finance',
  parent_id: null,
  principles: [
...
export const DOMAIN_LEARNING: Domain = createDomain({
  id: 'D5',
  name: 'Learning',
  parent_id: null,
  principles: [
...
export const STARTER_DOMAINS: ReadonlyArray<Domain> = Object.freeze([
  DOMAIN_PERSONAL,
  DOMAIN_PRODUCT,
...
export const CHARTER_DAILY_PULSE: Charter = createCharter({
  id: 'C-daily-pulse',
...
export const CHARTER_BUILD_PRODUCT: Charter = createCharter({
  id: 'C-build-product',
...
export const CHARTER_RELATIONSHIPS_TOUCHPOINTS: Charter = createCharter({
...
export const CHARTER_MONTHLY_FINANCE_REVIEW: Charter = createCharter({
...
export const CHARTER_WEEKLY_LEARNING_LOOP: Charter = createCharter({
...
export const CHARTER_ONBOARDING: Charter = createCharter({
  id: 'C-onboarding',
...
export const STARTER_CHARTERS: ReadonlyArray<Charter> = Object.freeze([
  CHARTER_DAILY_PULSE,
 ...
 */
function singleStepWorkflow(spec: Omit<WorkflowSpec, 'step_graph' | 'inputs' | 'outputs' | 'state' | 'interfaces_with'> & {
  step?: WorkflowSpec['step_graph'][number]
...
function multiStepWorkflow(
  spec: Omit<WorkflowSpec, 'step_graph' | 'inputs' | 'outputs' | 'state' | 'interfaces_with'> & {
    steps: WorkflowSpec['step_graph']
    inputs?: WorkflowSpec['inputs']
    outputs?: WorkflowSpec['outputs']
  },
): Workflow {
...
export const W_MORNING_PULSE: Workflow = singleStepWorkflow({
  id: 'W-morning-pulse',
...
export const W_EVENING_SHUTDOWN: Workflow = singleStepWorkflow({
 ...
 */
export const W_FEATURE_BUILD: Workflow = multiStepWorkflow({
  id: 'W-feature-build',
 ...
 */
export const W_BUG_FIX: Workflow = multiStepWorkflow({
  id: 'W-bug-fix',
...
export const W_ONE_ON_ONE_PREP: Workflow = singleStepWorkflow({
  id: 'W-1on1-prep',
...
export const W_RELATIONSHIP_CHECKIN: Workflow = singleStepWorkflow({
...
export const W_MONTHLY_FINANCE_REVIEW: Workflow = multiStepWorkflow({
...
export const W_LEARNING_SUMMARY: Workflow = singleStepWorkflow({
...
export const W_ONBOARDING_TOUR: Workflow = singleStepWorkflow({
...
export const W_ONBOARDING_CREATE_DOMAIN: Workflow = singleStepWorkflow({
...
export const STARTER_WORKFLOWS: ReadonlyArray<Workflow> = Object.freeze([
  W_MORNING_PULSE,
  W_EVENING_SHUTDOWN,
  W_FEATURE_BUILD,
  W_BUG_FIX,
...
export const T_MORNING_PULSE: TriggerSpec = {
  id: 'T-morning-pulse',
  event_type: 'cron',
 ...
 */
export const T_BUILD_FEATURE: TriggerSpec = {
  id: 'T-build-feature',
...
export const T_BUG_FIX: TriggerSpec = {
  id: 'T-bug-fix',
  event_type: 'founder_input',
  route_predicate: {
    type: 'or',
 ...
 */
export const T_ONBOARDING: TriggerSpec = {
  id: 'T-onboarding',
  event_type: 'founder_input',
  route_predicate: {
    type: 'or',
...
export const T_LEARNING_SUMMARY: TriggerSpec = {
...
export const STARTER_TRIGGERS: ReadonlyArray<TriggerSpec> = Object.freeze([
  T_MORNING_PULSE,
  T_BUILD_FEATURE,
  T_BUG_FIX,
  T_ONBOARDING,
...
export const STARTER_WORKFLOW_CHARTER_MAP: ReadonlyMap<string, string> = new Map([
...
export const ONBOARDING_WORKFLOW: Workflow = W_ONBOARDING_TOUR

// =============================================================================
// Aggregate — what `loadStarterKit()` returns
// =============================================================================
...
export function loadStarterKit(): StarterKit {
