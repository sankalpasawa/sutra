 ...
 */
function idForKind(kind: AgentKind) {
 ...
 */
export function createAgentIdentity(input: AgentIdentity): AgentIdentity {
 ...
 */
export function isValidAgentIdentity(v: unknown): v is AgentIdentity {
