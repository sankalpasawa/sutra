 ...
 */
export declare const EXTENSION_REF_PATTERN: RegExp;
/**
 ...
 */
export declare const ExtensionRefSchema: z.ZodUnion<readonly [z.ZodString, z.ZodNull]>;
 ...
 */
export declare function isValidExtensionRef(v: unknown): v is ExtensionRef;
