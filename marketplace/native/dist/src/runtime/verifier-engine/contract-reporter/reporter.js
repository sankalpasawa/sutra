 ...
 */
export function formatTranscript(utterance, run) {
...
export function formatReport(report) {
    ...
    report.results.forEach((r, i) => {
        lines.push(`| ${String(i + 1).padEnd(2)} | ${r.tier.padEnd(9)} | ${trunc(r.id, 30).padEnd(30)} | ${r.axis.padEnd(20)} | ${r.status.padEnd(6)} |`);
    });
    lines.push('+----+-----------+--------------------------------+----------------------+--------+');
    lines.push('');
