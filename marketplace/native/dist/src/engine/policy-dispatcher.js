 ...
 */
import { policyEvalActivity, } from './opa-evaluator.js';
 ...
 */
export function makePolicyDispatcher(bundleService, otelEmitter) {
    if (typeof bundleService !== 'object' || bundleService === null) {
        throw new TypeError('makePolicyDispatcher: bundleService must be an OPABundleService instance');
    }
 ...
 */
async function emitPolicyDecision(emitter, cmd, decision) {
...
//# sourceMappingURL=policy-dispatcher.js.map