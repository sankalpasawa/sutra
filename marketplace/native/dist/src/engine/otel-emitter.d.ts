 ...
 */
export type OTelEventKind = 'POLICY_ALLOW' | 'POLICY_DENY' | 'SKILL_RESOLVED' | 'SKILL_UNRESOLVED' | 'SKILL_RECURSION_CAP' | 'STEP_START' | 'STEP_COMPLETE' | 'STEP_FAIL' | 'FAILURE_POLICY_ROLLBACK' | 'FAILURE_POLICY_ESCALATE' | 'FAILURE_POLICY_PAUSE' | 'FAILURE_POLICY_ABORT' | 'FAILURE_POLICY_CONTINUE' | 'GOVERNANCE_OVERHEAD_ALERT' | 'HOST_LLM_INVOCATION' | 'DECIDE' | 'EXECUTE' | 'OVERRIDE' | 'APPROVE' | 'REJECT' | 'DELEGATE' | 'TERMINATE' | 'AUDIT';
/**
 ...
 */
export declare class InMemoryOTelExporter implements OTelExporter {
    /**
     ...
     */
    readonly records: OTelEventRecord[];
    /**
 ...
 */
export declare class NoopOTelExporter implements OTelExporter {
    export(_records: ReadonlyArray<OTelEventRecord>): Promise<void>;
    flush(): Promise<void>;
}
/**
 ...
 */
export declare class OTLPHttpExporter implements OTelExporter {
 ...
 */
export declare class OTelEmitter {
    private readonly exporter;
    constructor(exporter: OTelExporter);
    /**
     ...
     */
    emit(record: OTelEventRecord): Promise<void>;
