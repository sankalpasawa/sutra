...
import { type PolicyDecision, type PolicyInput } from './opa-evaluator.js';
 ...
 */
export declare function makePolicyDispatcher(bundleService: OPABundleService, otelEmitter?: OTelEmitter): PolicyDispatcher;
//# sourceMappingURL=policy-dispatcher.d.ts.map