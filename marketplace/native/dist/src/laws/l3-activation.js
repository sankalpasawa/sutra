...
export const l3Activation = {
    ...
    shouldActivate(event, spec) {
        ...
        const e = event;
        const s = spec;
        if (typeof e.spec_id !== 'string' || typeof s.id !== 'string')
            return false;
        if (e.spec_id !== s.id)
            return false;
        if (typeof s.payload_validator !== 'function')
            return false;
        if (typeof s.route_predicate !== 'function')
            return false;
        let schemaOk;
        try {
            schemaOk = s.payload_validator(e.payload) === true;
        }
        catch {
            return false;
        }
        ...
        let routeOk;
        try {
            routeOk = s.route_predicate(e.payload) === true;
        }
        catch {
            return false;
        }
...
//# sourceMappingURL=l3-activation.js.map