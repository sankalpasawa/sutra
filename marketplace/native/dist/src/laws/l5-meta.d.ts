 ...
 */
export type TypedEdgeKind = 'operationalizes' | 'decomposes_into' | 'depends_on' | 'produces' | 'consumes' | 'activates' | 'interfaces_with' | 'propagates_to';
/** Either containment or one of the typed edges. */
export type EdgeKind = 'contains' | TypedEdgeKind;
export declare const l5Meta: {
    /**
...
//# sourceMappingURL=l5-meta.d.ts.map