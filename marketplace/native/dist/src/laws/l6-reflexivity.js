...
export const l6Reflexivity = {
     ...
     */
    requiresApproval(workflow, constraints, satisfaction = {}) {
        ...
        if (!Array.isArray(constraints))
            return true;
        const reflexive = constraints.filter((c) => typeof c === 'object' && c !== null && isReflexiveCheck(c));
        ...
        for (const c of reflexive) {
            ...
            if (typeof sat !== 'object' || sat === null)
                continue;
            if (typeof sat.founder_authorization !== 'boolean')
                continue;
            if (typeof sat.meta_charter_approval !== 'boolean')
                continue;
     ...
     */
    reflexiveChecks(constraints) {
        if (!Array.isArray(constraints))
            return [];
        return constraints.filter((c) => typeof c === 'object' && c !== null && isReflexiveCheck(c));
    },
};
//# sourceMappingURL=l6-reflexivity.js.map