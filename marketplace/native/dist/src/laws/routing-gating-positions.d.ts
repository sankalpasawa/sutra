 ...
 */
export declare const ROUTING_GATING_POSITIONS: readonly ["Workflow.preconditions", "Workflow.failure_policy", "Workflow.step_graph[i].action", "Workflow.step_graph[i].skill_ref", "Workflow.expects_response_from", "Workflow.on_override_action", "Charter.acl[]", "Charter.obligations[i].mechanization", "TriggerSpec.pattern", "BoundaryEndpoint.class"];
 ...
 */
export type MachineCheckabilityKind = 'typed_enum' | 'typed_record' | 'typed_ref' | 'typed_parser' | 'parser-bound';
/**
 ...
 */
export declare const ROUTING_GATING_REPRESENTATIONS: Record<RoutingGatingPosition, MachineCheckabilityKind>;
/**
 ...
 * machine-checkable.
 */
export declare function isMachineCheckable(field: RoutingGatingPosition): boolean;
/**
 ...
 */
export declare function allRoutingGatingMachineCheckable(): boolean;
//# sourceMappingURL=routing-gating-positions.d.ts.map