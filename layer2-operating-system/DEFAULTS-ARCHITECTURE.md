...
| Writing style (D6, D13, D14, P11, D72) | Founder confidence — primary human-AI interface | HARD Stop gate `writing-style-gate.sh` + PostToolUse `md-standard-gate.sh`. See `core:writing-style` |
