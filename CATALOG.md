...
| **Website** (v0) | active | 1 (Asawa-level) | Owns every public web surface — Asawa, Sutra, Dawny (and future portfolio sites); content ↔ reality contract, refresh playbook, GitHub Pages deploy surface | Trigger: founder refresh request or drift detection; on-demand via `PLAYBOOK.md` | `holding/departments/website/CHARTER.md` |
